...
class Factory {
  constructor() {
    ...
    this.massBuild = function (quantity, options){
      console.log("Building " +quantity+ options+"'s");
    }
...
class Sport extends Car {
  constructor(model, trim, transmission, top, color, seatstrim, audio, wheelstrim){
    super (Car.moonroof, Car.enginetype, Car.doors);
    this.model = model;
    this.doors = 2;
    this.color = color;
...
class Truck extends Factory {
  constructor(model, doors, trim, color, enginesize, hitch, bed, navigation){
    super (Factory.warranty);
    this.model = model;
    this.doors = doors;
    this.color = color;
...
miataRf.customerBuild([miataRf.color, miataRf.trim, miataRf.model],["hid headlights", "sports suspension", "leather steering wheel", "heated seats", "adaptive cruise control"]);
...
let trailBlazer = new Truck("Trail Blazer", 2, "Sport", "blue", 8, true, "standard", true);
